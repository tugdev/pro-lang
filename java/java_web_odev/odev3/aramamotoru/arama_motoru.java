...
public class arama_motoru extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<!DOCTYPE html>\n" +
				...
				"<body bgcolor=\"#99cc99\" style = \" margin-top:50px;margin-left: 4.7in\">\n<h1 style = \"color:#6666cc;margin-left: 1in\">Arama Motoru </h1><br>"+
				"<div class = hero-unit style = width:500px;height:200px>"+
				"<FORM ACTION=\"" + URL + "\">\n" + "  <INPUT TYPE=\"TEXT\" NAME=\"searchString\" class=\"input-medium search-query\" style =\"width:2.5in;margin-left: 0.9in\"><P>\n");
